...
const Cart = () => {
  return (
    <div className="group flex flex-col justify-center items-center md:cursor-pointer relative order-3 md:order-4">
      ...
      <div className="absolute bg-white top-full w-max right-0 py-2 text-sm rounded-b-md rounded-l-md lg:rounded-r-md cursor-default hidden md:group-hover:block group-hover:shadow-[0_0_5px_0px_rgba(0,0,0,0.2)] ">
        <CartProducts />
      </div>
    </div>
  );
